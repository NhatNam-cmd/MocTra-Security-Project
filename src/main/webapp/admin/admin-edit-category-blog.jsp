            ...
            <div class="form-grid">
                ...
                <div class="form-left">
                    <div class="form-section">
                        ...
                        <form action="${ctx}/admin/blog-categories/edit" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description"
                                          class="form-control textarea" rows="4">${category.description}</textarea>
                            </div>
                            ...
                            <div class="btn-group">
                                <a href="${ctx}/admin/blog-categories" class="btn btn-outline">
                              ...
                              ${cat.isActive ? 'Hiển thị' : 'Ẩn'}
                                        ...
                                        <td>
                                            <div class="action-buttons">
                                                <a href="${ctx}/admin/blog-categories/edit?id=${cat.id}"
