...
<head>
    ...
    <style>
        ...
        .btn-bulk-deactivate:hover { background-color: #fed7d7; }
    ...
    <main class="admin-main">
        ...
        <div class="admin-content">
            ...
            <div id="selectPageAlert" class="selection-alert" style="display:none;">
                Bạn đã chọn <strong><span id="currentPageCount">0</span></strong> khách hàng trên trang này.
            ...
            <div id="selectAllAlert" class="selection-alert selection-alert-success" style="display:none;">
                Đang chọn tất cả <strong>${totalCustomers}</strong> khách hàng trong hệ thống.
                        ...
                        <c:forEach var="c" items="${customers}">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <div class="product-description-cell">ĐC: ${c.province != null ? c.province : 'Chưa cập nhật'}</div>
                                </td>
                                <td>
        ...
        <div class="bulk-actions-bar" id="bulkActionsBar">
            <div class="bulk-actions-info">
                <input type="checkbox" class="product-checkbox" id="selectAllCustomers" style="display:none;"> <span style="font-weight: 500; color: #4a5568;">Đã chọn <strong id="selectedCount" style="color: #2b6cb0; font-size: 16px;">0</strong> khách hàng</span>
            </div>
